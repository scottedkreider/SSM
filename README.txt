...
4. Use command line to navigate to the folder (Users -> Documents -> Github -> StudentScheduleManager)
5. (first time / maybe) run "npm install" in the command prompt
6. Run "npm start" in the command prompt
